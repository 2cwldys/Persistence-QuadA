/datum/computer_file/program/ctac
	filename = "CtaC"
	filedesc = "Black Market Shipments"
	nanomodule_path = /datum/nano_module/program/supply
	program_icon_state = "supply"
	program_menu_icon = "cart"
	extended_desc = "A military shipment program. Allows the user to be supplied with various military grade equipment."
	size = 21
...
/datum/nano_module/program/ctac
	name = "Black Market Shipments"
...
/datum/nano_module/program/ctac/ui_interact(mob/user, ui_key = "main", datum/nanoui/ui = null, force_open = 1, state = GLOB.default_state)
...
/datum/nano_module/program/ctac/Topic(href, href_list)
	var/mob/user = usr
	if(..())
		return 1
	var/datum/world_faction/connected_faction
